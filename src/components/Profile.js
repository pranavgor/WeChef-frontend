...
const columns = [
    {
        ...
        options: {
            ...
            return (
                    <Avatar src={val} sx={{ marginLeft:'10px',height:'100px', width:'100px'}}></Avatar>
                )
            },
        }
    },
...
function Profile() {
    ...
    useEffect(()=>{
        ...
        axios.get("http://localhost:5000/recipes/self", { headers: headers, method: 'GET'})
        .then(res => {
            if (res.status === 200) {
                let ans = []
